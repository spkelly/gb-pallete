...
export const SET_CONVERTED_PIXEL_DATA = "SET_CONVERTED_PIXEL_DATA";

export const SET_SELECTED_COLOR = "SET_SELECTED_COLOR";
export const SET_SELECTED_PALETTE_VALUE = "SET_SELECTED_PALETTE_VALUE"
//Actions
export const UPDATE_OUTPUT = "";
export const CONVERT_PIXEL_DATA = "";
